/**
 *  @file   larpandoracontent/LArVertex/ND_GlobalAsymmetryFeatureTool.h
 *
 *  @brief  Header file for the global asymmetry feature tool class.
 *
 *  $Log: $
 */
#ifndef LAR_ND_GLOBAL_ASYMMETRY_FEATURE_TOOL_H
#define LAR_ND_GLOBAL_ASYMMETRY_FEATURE_TOOL_H 1
...
/**
 *  @brief  ND_GlobalAsymmetryFeatureTool class
 */
class ND_GlobalAsymmetryFeatureTool : public ND_AsymmetryFeatureBaseTool
{
public:
    /**
